...
for i=1:N
    ...
    picp_test = PICP(squeeze(extractdata(test_out(i,:,2:end))), ...
        squeeze(pred_lower_test(i,:,:)), ...
        squeeze(pred_upper_test(i,:,:))); % Assuming you have upper/lower for test
    ...
    pinaw_val = PINAW(squeeze(extractdata(val_out(i,:,2:end))), ...
        squeeze(pred_lower_val(i,:,:)), ...
        squeeze(pred_upper_val(i,:,:))); % Assuming you have upper/lower for val
    pinaw_test = PINAW(squeeze(extractdata(test_out(i,:,2:end))), ...
        squeeze(pred_lower_test(i,:,:)), ...
        squeeze(pred_upper_test(i,:,:))); % Assuming you have upper/lower for test
